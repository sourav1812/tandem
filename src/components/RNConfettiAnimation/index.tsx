...
import {ConfettiAnimationProps} from './interface';

const colors = ['#a864fd', '#29cdff', '#78ff44', '#ff718d', '#fdff6a'];

const NUM_OF_CONFETTI = 60;
...
const ConfettiPiece = ({
  ...
  const matrix = useComputedValue(() => {
    const rotateZ =
      relativeSin(yPosition.current, Math.round(Number(offsetId))) * seed * 4;
    const rotateY =
...
export const RNConfettiAnimation = ({}: ConfettiAnimationProps) => {
